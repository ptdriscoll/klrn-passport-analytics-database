...
#this just makes sure names are more python-like
...
df_sust.to_csv(root_tables + '/df_sust_{}.csv'.format(date_naming), encoding='utf-8-sig')
...
df_first.to_csv(root_tables + '/df_first_{}.csv'.format(date_naming), encoding='utf-8-sig')
...
df_major.to_csv(root_tables + '/df_major_{}.csv'.format(date_naming), encoding='utf-8-sig')
